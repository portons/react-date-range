...
var Calendar = (function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderMonthAndYear(classes) {
      ...
      var currentMonth = this.props.maxDate && this.props.maxDate.diff(shownDate) === 0;
      var lastMonth = this.props.minDate && this.props.minDate.diff(shownDate) === 0;

      return _react2['default'].createElement(
        'div',
        { style: onlyClasses ? undefined : styles['MonthAndYear'], className: classes.monthAndYearWrapper },
        !lastMonth && _react2['default'].createElement(
          'button',
          {
        ...
        !currentMonth && _react2['default'].createElement(
          'button',
          {
